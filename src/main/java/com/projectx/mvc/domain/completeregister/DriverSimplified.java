...
public class DriverSimplified {
	...
	public DriverSimplified(Long driverId, String bloodGroup, Long mobile,
	...
	public DriverSimplified(String bloodGroup, Long mobile,
			Long homeContactNumber, Date drivingSince, Date employedSince,
			Boolean isFreightRequestPermissionGiven,
			Boolean isDealFinalizationPermissionGiven, String language,
			Long vendorId, Integer requestedBy, Long requestedById) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DriverSimplified other = (DriverSimplified) obj;
		if (bloodGroup == null) {

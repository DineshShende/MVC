...
public class SendResendResetPasswordRestDTO {
	...
	public SendResendResetPasswordRestDTO() {
		super();
	}

	public SendResendResetPasswordRestDTO(Long customerId,
			Integer customerType, Integer emailOrMobile,
			Integer sendOrResendOrResetFlag, Integer updatedBy, Long updatedById) {
		super();
	...
	public String toString() {
		return "SendResendResetPasswordRestDTO [customerId=" + customerId
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SendResendResetPasswordRestDTO other = (SendResendResetPasswordRestDTO) obj;
		if (customerId == null) {

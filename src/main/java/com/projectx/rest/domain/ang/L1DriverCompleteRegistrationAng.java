...
public class L1DriverCompleteRegistrationAng {
	...
	public L1DriverCompleteRegistrationAng() {
		super();
	}


	public L1DriverCompleteRegistrationAng(Long driverId, String firstName,
	...
	public L1DriverCompleteRegistration toL1DriverCompleteRegistration()
	{
		return new  L1DriverCompleteRegistration(this.driverId, this.firstName, this.middleName,
				this.lastName, this.dateOfBirth, this.addressLine, this.city, this.district, this.state, this.pincode, 
				this.licenceNumber, this.licenceDOI, this.licenceValidTill, this.covList, this.isDetailRegistrationCompleted);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		L1DriverCompleteRegistrationAng other = (L1DriverCompleteRegistrationAng) obj;
		if (addressLine == null) {
